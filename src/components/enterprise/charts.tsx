...
export function HealthScoreRing({ score }: { score: number }) {
  ...
  return (
    <motion.div className="h-full">
      <GlassPanel className="erp-dark-glass card-shine flex h-full min-h-[280px] flex-col items-center justify-center p-6 transition-all duration-200 hover:border-violet-500/35 hover:shadow-xl hover:shadow-violet-500/15">
