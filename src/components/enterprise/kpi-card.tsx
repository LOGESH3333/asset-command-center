...
export function KpiCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "erp-dark-glass card-shine group relative overflow-hidden rounded-2xl p-5 backdrop-blur-xl transition-all duration-200",
        colors.glow,
        "hover:border-violet-500/35 hover:shadow-2xl hover:shadow-violet-500/15"
      )}
    >
      <div
        className={cn(
