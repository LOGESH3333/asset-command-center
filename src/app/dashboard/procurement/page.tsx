...
import { listProcurementMetricsAction, listProcurementsAction } from '@/app/actions/brd/procurement';
...
export default function ProcurementPage() {
  ...
  useEffect(() => {
    listProcurementMetricsAction().then((result) => {
  ...
  const fetchRows = useCallback(async () => {
    ...
    setError(null);
    try {
      const result = await listProcurementsAction({ status, search, page, pageSize: PAGE_SIZE });
      if (result.error) setError(result.error);
