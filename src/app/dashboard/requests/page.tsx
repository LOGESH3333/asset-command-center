          ...
          toolbar={
            <div className="flex flex-col gap-4 md:flex-row md:items-center">
              ...
              <Select value={status} onValueChange={(v) => { setStatus(v ?? 'ALL'); setPage(1); }}>
                <SelectTrigger className="erp-dark-glass-interactive w-full rounded-xl border text-zinc-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] md:w-[220px]"><SelectValue placeholder="Status" /></SelectTrigger>
                <SelectContent>
