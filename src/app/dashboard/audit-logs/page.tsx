            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Select value={actionFilter} onValueChange={(v) => { setActionFilter(v ?? 'ALL'); setPage(1); }}>
                  <SelectTrigger className="erp-dark-glass-interactive w-[150px] rounded-xl border text-zinc-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]"><SelectValue /></SelectTrigger>
                  <SelectContent>
