...
import { PlusIcon, EyeIcon, PencilIcon, LayoutGrid, Table2, QrCode } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <GlassPanel className="p-4">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <div className="erp-dark-glass flex rounded-xl p-1">
              <Button
                type="button"
                variant="ghost"
                size="sm"
            ...
            <Select value={statusFilter} onValueChange={handleStatusChange}>
              <SelectTrigger className="erp-dark-glass-interactive w-full rounded-xl border text-zinc-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] md:w-[200px]">
      ...
      <RegistryDeleteDialog
        ...
        title="Delete Asset"
        description="Permanently remove this asset. This action cannot be undone."
        detail={deleteTarget ? `${deleteTarget.name} (${deleteTarget.asset_tag})` : null}
