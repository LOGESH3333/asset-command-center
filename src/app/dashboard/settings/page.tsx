...
import { REGISTRY_INPUT_SURFACE, REGISTRY_PANEL_SURFACE } from '@/lib/ui/registry-surface';
        ...
        <GlassPanel className="p-3 md:col-span-1">
          <nav className="space-y-1">
            ...
            <button
              type="button"
              disabled
              className="flex w-full cursor-not-allowed items-center gap-2 rounded-xl px-3 py-2.5 text-sm text-zinc-500 opacity-50"
            >
          ...
          {activeTab === 'general' ? (
            <GlassPanel className="p-6">
              <div className="mb-6 border-b border-glass-border pb-4">
                <h3 className="font-semibold text-white">General System Configuration</h3>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className={REGISTRY_INPUT_SURFACE}
                    />
                  </div>
                  <div className="space-y-2">
            ...
            <GlassPanel className="p-6">
              <div className="mb-6 border-b border-glass-border pb-4">
                <h3 className="font-semibold text-white">Authentication Settings</h3>
                <p className="text-xs text-zinc-400">
              ...
              <div className="space-y-6">
                <div className={cn(REGISTRY_PANEL_SURFACE, 'flex items-center justify-between p-4')}>
                  <div className="space-y-0.5">
                    <span className="text-sm font-semibold text-white">Supabase Authentication</span>
                    <p className="text-xs text-zinc-400">Enterprise SSO and session management.</p>
                  </div>
                  {user ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className={cn(REGISTRY_PANEL_SURFACE, 'grid grid-cols-3 gap-y-3 gap-x-2 p-4 text-sm')}>
                    ...
                    <span className="text-zinc-400">Active Email</span>
                    <span className="col-span-2 font-mono text-xs text-zinc-100">{user?.email ?? '—'}</span>
