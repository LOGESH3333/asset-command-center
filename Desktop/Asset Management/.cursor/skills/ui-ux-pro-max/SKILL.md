---
name: ui-ux-pro-max
description: Comprehensive design guide for web and mobile applications with 67 styles, color palettes, font pairings, UX guidelines, and chart types across multiple stacks. Use when building, designing, reviewing, or improving UI/UX for landing pages, dashboards, components, or mobile apps.
---
