  ...
  useEffect(() => {
    ...
    async function loadActivity() {
      ...
      try {
        ...
        const [requestsRes, maintRes, notifRes, auditRes, allocRes, approvalRes] = await Promise.all([
          ...
          supabase
            ...
            .select("id, approval_stage, status, decided_at, created_at, asset_requests(justification)")
        ...
        approvalRes.data?.forEach((a) => {
          const justification = (a.asset_requests as { justification?: string } | null)?.justification;
          combined.push({
            id: `approval-${a.id}`,
            type: "request",
