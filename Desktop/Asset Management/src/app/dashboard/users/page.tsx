...
import { PlusIcon, EyeIcon, PencilIcon, Trash2Icon, Loader2Icon, Users, Shield, Building2, UserPlus } from 'lucide-react';
...
function UsersPageContent() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      else { setDialogOpen(false); setDeleteTarget(null); fetchUsers(); }
    } catch (err: unknown) {
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="rounded-2xl border-white/10 bg-[#0a0a0f]">
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete <strong>{deleteTarget ? `${deleteTarget.first_name} ${deleteTarget.last_name}` : ''}</strong>? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
