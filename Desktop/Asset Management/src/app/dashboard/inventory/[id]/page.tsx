...
import { getInventoryItem } from '@/lib/supabase/brd/inventory';
import { updateInventoryAction } from '@/app/actions/brd/inventory';
...
function InventoryEditForm() {
  ...
  useEffect(() => {
    Promise.all([getInventoryItem(id), getBrdFormLookupsAction()]).then(([itemResult, lookups]) => {
