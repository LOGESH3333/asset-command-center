...
import { PlusIcon, EyeIcon, PencilIcon, Trash2Icon, Loader2Icon, Wrench, CalendarClock, AlertTriangle, DollarSign, Percent } from 'lucide-react';
...
export default function MaintenancePage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      else { setDialogOpen(false); setDeleteTarget(null); fetchRecords(); }
    } catch (err: unknown) {
          ...
          toolbar={
            <div className="flex flex-col gap-4 md:flex-row md:items-center">
              ...
              <Select value={type} onValueChange={handleTypeChange}>
                <SelectTrigger className="w-full rounded-xl border-violet-500/20 bg-white/[0.03] md:w-[200px]"><SelectValue placeholder="All Types" /></SelectTrigger>
                <SelectContent>
