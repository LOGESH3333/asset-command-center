...
import { getRequestApprovalHistory } from '@/lib/supabase/brd/approvals';
import { formatPersonName } from '@/lib/display-labels';
import { isPendingRequestStatus } from '@/lib/constants/request-status';
...
export default function RequestDetailsPage() {
  ...
  const showApprovalLink = pendingApproval && canManageApprovals(role);
